...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
	            <div class="col-md-8">
	                <form action="member_join_process.jsp" class="form-horizontal" method="post" enctype ="multipart/form-data">
	                ...
	                <div class="form-group row">
		                ...
		                <div class="col-sm-3">
                            <select type="text" id="memberGender" name="memberGender" class="form-control">
                    ...
                    <div class="form-group row">
		                ...
		                <div class="col-sm-3">
			                <input type="date" id="memberBirth" name="memberBirth" class="form-control" value="<%= sfd.format(nowDate)%>" max="<%= sfd.format(nowDate)%>">
		                </div>
	                </div>
	                <div class="form-group row">
		                <label class="col-sm-3">메일주소</label>
		                <div class="col-sm-4">
			                <input type="text" id="memberMail" name="memberMail" class="form-control" placeholder="example@gamil.com">
		                </div>
	                </div>
	                <div class="form-group row">
